        ...
        <div class="modal-body">
            ...
            <fieldset>
                <div class="control-group">
                    <?= $form->label('judul', ['class' => 'control-label']) ?> <small>(required)</small>
                    <div class="controls">
                ...
                <br>
                <div class="control-group">
                  <p><?= $form->label('deskripsi', ['class' => 'control-label']) ?> <small>(required)</small></p>  
                    <div class="controls">
                ...
                <br>
                <div class="">
                    <?= $form->label('foto', ['class' => 'control-label']) ?> <small>(required)</small>
                    <div class="">
